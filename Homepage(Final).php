...
<table>
	<tr>
		<td rowspan="2"><a href="Homepage(Final).php" target="_self"> <img src="allpicture/proton.png" width="50px" height="50px"/></a>
		</td>
		<td style="color:white" align="center">&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td><a href="Login.php" target="_self">Login </a></li></td>
		<td><a href="Feedback.php" target="_self">Feedback</a></li></td>
		<td><a href="satria neo.php" target="_self">Satria Neo</a></li></td>
		<td><a href="Exora.php" target="_self">Exora</a></li></td>
		<td><a href="suprimax.php" target="_self">Suprima S</a></li></td>
		<td><a href="iriz.php" target="_self">Iriz</a></li></td>
		<td><a href="car details.php" target="_self">All Vehicles</a></li></td>
		<td><a href="About.php" target="_self">About us</a></li></td>
		<td>
